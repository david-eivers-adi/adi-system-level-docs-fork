...
.. admonition:: Download
   ...
   .. TODO(wiki-migration): file removed from repo (backup: ~/eval-adicup360-resources-backup/);
      replace with its analog.com designsupport URL and restore the list:
   ...
   .. TODO(wiki-migration): files removed from repo (backup: ~/eval-adicup360-resources-backup/);
      replace each link below with its analog.com designsupport URL and restore the list:

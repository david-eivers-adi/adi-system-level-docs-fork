...
Arria10 GX Quick Start Guide (Obsolete)
================================================================================

.. warning::

   Support for the A10GX carrier is discontinued and will not be supported in
   future releases. The last supported HDL release is **hdl_2021_r1**. Last
   pre-build images can be found at
   :ref:`Nios2 Linux on the Altera FPGA Development Boards <linux-kernel nios2>`
   page.

This guide provides quick instructions on how to setup the
:adi:`ADRV9009-W/PCBZ <EVAL-ADRV9008-9009>` on:

- `A10GX <https://www.altera.com/products/devkit/po-3017/arria-10-gx-fpga-development-kit>`_ on FMCA
...
.. tip::
   ...
   :ref:`Pre-built images for Intel Arria 10 GX <linux-kernel nios2>`
